...
## 5️⃣ Ajouter une navigation (React Router) — **1/4**
- **1/1** Installation et configuration correcte de React Router
- **0/1** Page "/" (Bienvenue) fonctionnelle
- **0/1** Page "/users" fonctionnelle
- **0/1** Navigation fluide sans rechargement
==> nav non fonctionnelle
